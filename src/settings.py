...
CLASS2COLOR: Optional[Dict[str, List[str]]] = {
    ...
    "adelholzener_classic_bio_apfelschorle": [255, 225, 25],
    "adelholzener_classic_bio_apfelschorle_bbox": [255, 225, 25],
    "adelholzener_classic_naturell": [0, 130, 200],
    "adelholzener_classic_naturell_bbox": [0, 130, 200],
    "adelholzener_gourmet_mineralwasser": [245, 130, 48],
    "adelholzener_gourmet_mineralwasser_bbox": [245, 130, 48],
    "augustiner_lagerbraeu_hell": [145, 30, 180],
    "augustiner_lagerbraeu_hell_bbox": [145, 30, 180],
    "augustiner_weissbier": [70, 240, 240],
    "augustiner_weissbier_bbox": [70, 240, 240],
    "coca_cola": [240, 50, 230],
    "coca_cola_bbox": [240, 50, 230],
    "coca_cola_light": [210, 245, 60],
    "coca_cola_light_bbox": [210, 245, 60],
    "suntory_gokuri_limonade": [250, 190, 212],
    "suntory_gokuri_limonade_bbox": [250, 190, 212],
    "tegernseer_hell": [0, 128, 128],
    "tegernseer_hell_bbox": [0, 128, 128],
    ...
    "apple_roter_boskoop": [240, 50, 230],
    "apple_roter_boskoop_bbox": [240, 50, 230],
    "avocado": [210, 245, 60],
    ...
    "rispentomaten": [170, 255, 195],
    "rispentomaten_bbox": [170, 255, 195],
    "roma_rispentomaten": [128, 128, 0],
    "roma_rispentomaten_bbox": [128, 128, 0],
    "rucola": [255, 215, 180],
